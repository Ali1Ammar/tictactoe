...
class BaseBoard extends ChangeNotifier {
  List _boardState = List.generate(9, (_) => null);
  List finalWinner;
  ...
  bool isWinner(String playerNow, {boardSatae}) {
    if (boardSatae == null) {
      boardSatae = _boardState;
    }
    for (List state in _winnerState) {
